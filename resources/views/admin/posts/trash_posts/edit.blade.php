...
<div class="page-content-wrap">
	<div class="row">
		<form method="POST" id="form_validate" action="{{route('admin-trash-posts-update' , ['id' => $post->id])}}" {{-- action="javascript:alert('Form #validate submited');" --}} enctype="multipart/form-data" class="form-horizontal">
			@csrf
			{{method_field('patch')}}
		<div class="col-md-8">
		...
		<div class="col-md-4">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body" title="Trạng thái bài viết" data-toggle="tooltip" >
					<span>Lưu thông tin bài viết trash</span>
				</div>
				<div class="panel-footer">
					<button class="btn btn-info pull-right" name="trash_post_submit_update" type="submit" style="font-size: 13px;font-weight: bold;">Lưu</button>
				</div>                                                                                          
			</div>
